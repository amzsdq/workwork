...
| 22m | next run | GITHUB_SERVER_MARKER_V1 | READY_TO_REVALIDATE | requires valid START/END marker pair | W3_MIXED_IO | pending |

## Current empirical conclusion

- LEGACY_EXPLORATORY_LOWER_BOUND: **20m**.
- SERVER_CLOCK_SAFE_LOWER_BOUND: **unresolved** until a valid `GITHUB_SERVER_MARKER_V1` strict pass is completed.
...
- Next strict target: **22m W3_MIXED_IO**, revalidated with GitHub server START/END marker comments.
...
- Raw validation resource returned server `created_at=2026-09-23T13:21:29Z`
