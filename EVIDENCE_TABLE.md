...
| 22m | PROBE-22M-SERVERCLOCK-20260923-R5 | GITHUB_SERVER_MARKER_V1 | CLOCK_EVIDENCE_INVALID / NON_DURATION_FAIL | START blocked; no WORKED | W3 | NONE |
...
- R3/R4/R6 are valid-marker UNDER_TARGET workload-corpus exhaustion/design outcomes, not duration failures. R6 materially expanded useful W3 work to 59 decision-relevant units and 975s but still saturated before 1320s.
- R5 is independent CLOCK_EVIDENCE_INVALID/NON_DURATION_FAIL.
- Repository-protocol audit work is now exhausted as a 22m workload source. Next repeat requires a genuinely larger implementation/data-processing task source; redundant documentation churn is forbidden.
...
R6 raw close: `runtime-boundary/PROBE-22M-SERVERCLOCK-20260924-R6/close.json`.
