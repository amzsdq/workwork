...
from ARTIFACT_ORDER_GUARD import ArtifactOrderState, require_terminal_construction_admission
...
def build_terminal(*,artifact_order:ArtifactOrderState,
    ...
    require_terminal_construction_admission(artifact_order)
...
if __name__=="__main__":
    artifact_order=ArtifactOrderState(raw_start_verified=True,start_artifact_persisted=True,terminal_or_interrupted_persisted=False,immutable_event_persisted=False)
