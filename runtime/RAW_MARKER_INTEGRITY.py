...
def first_token(body):return body.strip().split()[0] if body.strip() else ""
def metadata(body):
 out={}
 ...
 return out
def body_has_identity(body,probe_id,case_id):
 m=metadata(body)
 return m.get("probe_id")==probe_id and (case_id is None or m.get("case_id")==case_id)
...
if __name__=="__main__":
 def m(i,token,t,identity="probe_id=P case_id=C"):return {"id":i,"body":f"{token} {identity}","created_at":t}
 good=validate_lifecycle(m(1,"START_MARKER","2026-01-01T00:00:00Z"),m(2,"WORK_START_MARKER","2026-01-01T00:00:01Z"),m(3,"PRE_CLOSE_MARKER","2026-01-01T00:00:10Z"),m(4,"END_MARKER","2026-01-01T00:00:11Z"),{"START":1,"WORK_START":2,"PRE_CLOSE":3,"END":4},"P","C");assert good["valid"]
 assert not validate_marker(m(2,"WORK_START_MARKER","2026-01-01T00:00:01Z"),2,"START","P","C").valid
 assert not validate_marker(m(1,"START_MARKER","2026-01-01T00:00:00Z","probe_id=P10 case_id=C"),1,"START","P","C").valid
